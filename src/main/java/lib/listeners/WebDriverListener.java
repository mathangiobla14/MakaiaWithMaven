...
public class WebDriverListener extends Reports implements WebDriverEventListener {
	...
	public void afterChangeValueOf(WebElement element, WebDriver driver, CharSequence[] keysToSend) {
		if(keysToSend==null)
		{
			System.out.println("The value is cleared and hence no keys to send");	
		}
		else
		{
	...
	public void beforeSwitchToWindow(String windowName, WebDriver driver) {
		...
		//System.out.println("The Url of the window before it is switched to new window is "+ driver.getCurrentUrl());
		//System.out.println("The Title of the window before it is switched to new window is "+driver.getTitle());
		takeSnap();
	}

	public void afterSwitchToWindow(String windowName, WebDriver driver) {
		//System.out.println("The driver is moved to the window with title "+driver.getTitle());		
	//	System.out.println("The driver is moved to the window with title "+driver.getCurrentUrl());
		//driver.manage().window().maximize();
		//takeSnap();
